...
var CanvasParticle = (function(){
    ...
    function canvasInit(canvasConfig){
        ...
        var canvas_body = getELementById('canvas');
        var canvasDiv = getELementById("canvas-particle");
        // var canvasObj = canvas_body.createElement("canvas");
        var canvas = {
            element: canvas_body,
            points : [],
            // 默认配置
        ...
        canvas_body.style.padding = "0";
        canvas_body.style.margin = "0";
        // body.replaceChild(canvas.element, canvasDiv);
        // canvas_body.appendChild(canvas.element);

        canvas.element.style = "position: absolute; top: 0; left: 0; z-index: -1;  background-color: #0c0c0e;";
        canvasSize(canvas.element);
        window.onresize = function(){
            canvasSize(canvas.element);
        };
        canvas_body.onmousemove = function(e){
    ...
    function canvasSize(canvas){
        ...
        // canvas.width = '100%';
        canvas.height = 1400||window.innerWeight || document.documentElement.clientWidth || document.body.clientWidth;
    }
